...
def draw(canvas):
    ...
    # draw paddles
    paddle1 = canvas.draw_polygon(paddle1_pos, 2, "White", "White")
    paddle2 = canvas.draw_polygon(paddle2_pos, 2, "White", "White")
    
    # draw scores
    score_player1 = canvas.draw_text(str(score1), [(WIDTH/2)-40, HEIGHT/2-100], 40, "White")
    score_player2 = canvas.draw_text(str(score2), [(WIDTH/2)+20, HEIGHT/2-100], 40, "White")
